...
/*
 * Name:sana
 * Description:Program to find longest consecutive element sequence from the given unsorted array
 */
...
public class LongestConsecutiveElementSequence {
	...
	public static void main(String[] args) {
		int arr[]= {49,1,3,200,2,4,70,5,50,53,52,56,51,54,55};
        Arrays.sort(arr);
		String str="";
		int count=0;
		//1,2,3,4,5,49,50,51,52,53,54,55,56,200
